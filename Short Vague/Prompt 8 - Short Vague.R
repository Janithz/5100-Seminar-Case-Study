#PROMPT
#You 
#gave the same wrong graph but red now

#ChatGPT
#My apologies for the oversight. It seems we need to adjust the indexing for extracting columns based on levels. Let's correct that:
...
#This adjusted code should correctly plot multiple waveforms based on different levels. If you encounter any further issues or need additional assistance, feel free to ask!
